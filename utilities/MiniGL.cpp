...
void MiniGL::coordinateSystem() 
{
	...
	Eigen::Vector3f b(0.25,0,0);
	Eigen::Vector3f c(0,0.25,0);
	Eigen::Vector3f d(0,0,0.25);

	float diffcolor [4] = {1,0,0,1};
	float speccolor [4] = {1,1,1,1};
	glColor3fv (diffcolor);
	glLineWidth (2);
